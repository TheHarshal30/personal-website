...
(image is generated using gpt, if you find any faluts pls reach out [here](https://help.openai.com/en))
...
The matrix operations handle all samples simultaneously, eliminating per-sample loops. This is where the true power of matrix notation shines.
