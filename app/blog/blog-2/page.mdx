...
but from earlier equation I rewrote the gradient equation by replacing jacobian matrix with weight matrix like this:
...
As you can see the gradients are stable and they wont explode or vanish even if we have huge depth in our neural network
